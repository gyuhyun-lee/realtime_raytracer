...
void VkApp::createRtDescriptorSet()
{
    m_rtDesc.setBindings(m_device, {
            ...
            {1, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1,  // m_rtColCurrBuffer
             VK_SHADER_STAGE_RAYGEN_BIT_KHR},

            {2, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1,  // m_rtColPrevBuffer
             VK_SHADER_STAGE_RAYGEN_BIT_KHR},

            {3, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1,  // m_rtNdCurrBuffer
             VK_SHADER_STAGE_RAYGEN_BIT_KHR},

            {4, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1,  // m_rtNdPrevBuffer
             VK_SHADER_STAGE_RAYGEN_BIT_KHR},

            {5, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1,  // m_rtKdCurrBuffer
             VK_SHADER_STAGE_RAYGEN_BIT_KHR}
        });
...
void VkApp::createRtPipeline()
{
    ...
    CHECKVKRESULT(vkCreatePipelineLayout(m_device, &pipelineLayoutCreateInfo, nullptr, &m_rtPipelineLayout));
    ...
    CHECKVKRESULT(vkCreateRayTracingPipelinesKHR(m_device, {}, {}, 1, &rayPipelineInfo, nullptr, &m_rtPipeline));
    for (auto& s : stages)
...
void VkApp::raytrace()
{
    ...
    m_pcRay.cameraMoved = (uint32)app->myCamera.cameraMoved;

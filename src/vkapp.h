...
do {                                                                            \
	...
	{                                                                           \
		printf("%s failed with VkResult: %i\n", #expression, vkResult);         \
		assert(0);                                                              \
	}                                                                           \
}while (0)																		\
...
public:
    ...
    BufferWrap m_scratch1; // New in part 3
    BufferWrap m_scratch2; // New in part 3

    ImageWrap m_rtColCurrBuffer{}; // accumulated ray traced image
    ImageWrap m_rtColPrevBuffer{};

    ImageWrap m_rtNdCurrBuffer{}; // normal and depth of the front most object
    ImageWrap m_rtNdPrevBuffer{};

    ImageWrap m_rtKdCurrBuffer{}; // color of the front most object

...
VkApp::VkApp(App* _app) : app(_app)
{
    ...
    myloadModel("models/living_room.obj", glm::mat4(1.0f));
...
{        
    ...
    app->myCamera.cameraMoved = false;
}
...
VkCommandBuffer VkApp::createTempCmdBuffer()
{
    ...
    CHECKVKRESULT(vkAllocateCommandBuffers(m_device, &allocateInfo, &cmdBuffer));
...
void VkApp::submitTempCmdBuffer(VkCommandBuffer cmdBuffer)
{
    ...
    CHECKVKRESULT(vkQueueSubmit(m_queue, 1, &submitInfo, {}));
    CHECKVKRESULT(vkQueueWaitIdle(m_queue));
